...
Error_Status LCD_WriteStringAsync(uint8_t *string, uint8_t length, CallBack_t CB)
{
    uint8_t Index;
    Error_Status LOC_Status = Status_NOK;
...
Error_Status LCD_WriteCommandAsync(uint8_t Command, CallBack_t CB)
{
    uint8_t Index;
    Error_Status LOC_Status = Status_NOK;
...
Error_Status LCD_SetCursorPositionAsync(uint8_t X_pos, uint8_t Y_pos, CallBack_t CB)
{
    uint8_t Index;
    Error_Status LOC_Status = Status_NOK;
...
static void OperationState_ClearFunc()
{
    ...
    case STATIC_STATE_BUSY:
        ...
        LCD_SetCursorPositionAsync(0, 0, NULL_PTR);
...
Error_Status LCD_GetStatus(uint8_t *Status)
{
    Error_Status LOC_Status = Status_NOK;

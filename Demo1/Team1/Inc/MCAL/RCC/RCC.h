 ...
 *                                Type Decelerations                           *
 *******************************************************************************/
/********************used in RCC_setClkON(uint32_t RCC_clk) API**********************/
 ...
 *
 * Parameters:
 *   - Copy_uint32_tPeriphral: The bitmask representing the peripherals to be enabled or disabled.
 ...
 *
 * Parameters:
 *   - Copy_uint32_tPeriphral: Bitmask representing the peripherals to be controlled.
